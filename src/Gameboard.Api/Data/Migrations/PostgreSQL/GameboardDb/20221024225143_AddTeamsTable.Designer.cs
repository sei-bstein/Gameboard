...
namespace Gameboard.Api.Data.Migrations.PostgreSQL.GameboardDb
{
    ...
    [Migration("20221024225143_AddTeamsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gameboard.Api.Data.ArchivedChallenge", b =>
                {
                    ...
                    b.Property<string>("InvitationHostId")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");
                    ...
                    b.Property<DateTimeOffset>("TeamCreatedOn")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Gameboard.Api.Data.Team", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)");
                    ...
                    b.Property<string>("InivitationHostId")
                        .HasColumnType("character varying(40)");
            ...
            modelBuilder.Entity("Gameboard.Api.Data.Player", b =>
                {
                    ...
                    b.HasOne("Gameboard.Api.Data.Team", "Team")
                        .WithMany("Players")
            ...
            modelBuilder.Entity("Gameboard.Api.Data.Team", b =>
                {
                    b.HasOne("Gameboard.Api.Data.Player", "InvitationHost")
                        .WithOne("InvitationHostForTeam")
                        .HasForeignKey("Gameboard.Api.Data.Team", "InivitationHostId");

                    b.Navigation("InvitationHost");
                });
            ...
            modelBuilder.Entity("Gameboard.Api.Data.Player", b =>
                {
                    ...
                    b.Navigation("InvitationHostForTeam");
