...
namespace Gameboard.Api.Services
{
    public class PlayerService
    {
        ...
        private readonly IHubContext<PlayerPresenceHub> _playerPresenceHub;

        public PlayerService(
            IPlayerStore store,
            IGameStore gameStore,
            IHubContext<PlayerPresenceHub, IPlayerPresenceEvent> playerPresenceHub,
            IMapper mapper,
        ...
        )
        {
            ...
            Mojo = mojo;
            _playerPresenceHub = playerPresenceHub;
        }
        ...
        public async Task<Player> Enlist(PlayerEnlistment model, bool sudo = false)
        {
            ...
            this._playerPresenceHub.Clients.Group(player.TeamId).
